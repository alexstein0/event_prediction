...
#python eval.py seed=42 name=amazon_movies experiment=amazon_movies_small data.size="_small" tokenizer_name=amazon_movies_5core_small_simple model.batch_size=64 model.seq_length=10 model_save_name="amazon_movies_small_2024-05-13-16-33" model.randomize_order=False
