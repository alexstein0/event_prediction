...
#python pretrain_HF.py data=ibm_fraud_transaction tokenizer=simple save_csv=True tokenizer_name="ibm_fraud_transaction_simple" tokenized_data_name="ibm_fraud_transaction" #data.size="_small"  #data.name=ibm_fraud_transaction_small_fixed
